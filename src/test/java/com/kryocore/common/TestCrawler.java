...
//    ArticleRepository articleRepository;
    ...
    private static Long sourceId = 888888L;
    private static String website = "http://www.ftchinese.com";
    private static String chromdriver="./chromedriver.exe";
    private static String crawlerUrl = "https://finance.sina.com.cn/roll/2018-10-16/doc-ifxeuwws4684632.shtml";
    ArticleRepository articleRepository;
    ...
    public TestCrawler(ArticleRepository articleRepository, CorpusRepository corpusRepository){
     ...
     * @return
     */
    public static List<WebElement> getArticleByChannel(WebDriver driver){
     ...
     * @return
     */
    public static void parseArticle(List<WebElement> webElements,WebDriver driver){
